...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=../../mocks/logger/mock_logger.go -package=mocklogger github.com/biairmal/go-sdk/lib/logger Logger
