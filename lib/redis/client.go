...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=../../mocks/redis/mock_redis.go -package=mockredis github.com/biairmal/go-sdk/lib/redis Client,Pipeliner
