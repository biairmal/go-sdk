...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=../../mocks/repository/mock_repository.go -package=mockrepository github.com/biairmal/go-sdk/lib/repository Repository,ReadRepository,WriteRepository,TransactionalRepository
