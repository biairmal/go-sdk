...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=../../mocks/ratelimit/mock_ratelimit.go -package=mockratelimit github.com/biairmal/go-sdk/lib/ratelimit Limiter
