...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=../../mocks/metrics/mock_metrics.go -package=mockmetrics github.com/biairmal/go-sdk/lib/metrics Recorder
