...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=../../mocks/auth/mock_auth.go -package=mockauth github.com/biairmal/go-sdk/lib/auth Validator,Claims,Issuer
