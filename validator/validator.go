...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=../mocks/validator/mock_validator.go -package=mockvalidator github.com/biairmal/go-sdk/validator Validator
