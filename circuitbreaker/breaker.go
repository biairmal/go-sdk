...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=../mocks/circuitbreaker/mock_circuitbreaker.go -package=mockcircuitbreaker github.com/biairmal/go-sdk/circuitbreaker Breaker
