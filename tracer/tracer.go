...
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -destination=../mocks/tracer/mock_tracer.go -package=mocktracer github.com/biairmal/go-sdk/tracer Tracer
